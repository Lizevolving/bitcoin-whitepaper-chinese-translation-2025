...
> **激励也来源于交易费。若一笔交易的输出值小于输入值，其差额即是交易费，会计入该区块的奖励之中。**
>
> **待预设的货币总量发行完毕，激励将完全由交易费承担，从而实现零通胀。**

**为何更好？**
1.  **锋利**：“若……即是……”，判断句式，干净果断。“会计入”，一个动词讲完去向。
2.  **质朴**：“发行完毕”、“由……承担”，都是最朴素直接的中文，毫无翻译腔。
3.  **深刻**：“承担”二字，不仅说明了来源，更暗示了其在经济模型中角色的转变和“接力”的责任，比“来自”更有深度。
...
2.  场景：一个>50%算力的攻击者。
3.  选择：欺诈 vs 创造新币。
4.  理性结论 (`ought to find`)：遵守规则**更赚钱** (`more profitable`)，因为他能拿到最多的奖励。破坏系统等于摧毁自己的财富**根基** (`validity of his own wealth`)。
...
> **这种激励机制也能鼓励节点保持诚实。一个掌握了过半算力的贪婪攻击者，将面临一个选择：是窃回自己的付款来行骗，还是用它来创造新币。**
>
> **他终将发现，遵守规则远比破坏系统更有利可图——因为规则会让他挖到比所有人都多的新币，而破坏系统则会动摇他自身财富的根基。**

**为何更好？**
1.  **有力**：“终将发现”对应`ought to find`，表达一种基于理性的必然，比“应该能够”更具宿命感和力量感。
2.  **一眼见底**：用破折号引出因果解释，结构清晰。“遵守规则 vs 破坏系统”、“更有利可图 vs 动摇根基”，对比强烈，矛盾一目了然。
3.  **意象统一**：“挖到”新币，呼应了前文的“矿工”和“挖矿”的类比，保持了整个白皮书核心意象的一致性。
